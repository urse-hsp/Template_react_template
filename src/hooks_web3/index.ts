...
import { useAppHashState } from '@/models/appHashState';
...
export const useHashMessage = () => {
  ...
  const successText_msg = t('Confirmed on the chain');
